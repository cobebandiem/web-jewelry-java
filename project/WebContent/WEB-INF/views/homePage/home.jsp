						...
						<li class="header__navbar-item header__navbar-item--notify">
							...
							<div class="header__notify">
									...
									<li class="header__notify-item">
										<a href="" class="header__notify-item-link header__notify-item--viewed">
											...
											<div class="header__notify-item-info">
												<c:if test="${listCartL==0}">
													<span class="header__notify-item-name">Giỏ hàng của bạn hiện đang trống:</span>
													<span class="header__notify-item-des">Hãy xem và tìm kiếm các sản phẩm phù hợp với ban.</span>
												</c:if>
												<c:if test="${listCartL!=0}">
													<span class="header__notify-item-name">Số đơn hàng đang tồn tại trong giỏ hàng:</span>
													<span class="header__notify-item-des">Hiện tại bạn đang có ${listCartL} sản phẩm trong giỏ hàng.</span>
												</c:if>
											</div>	
										</a>
									</li>
								...
								<footer class="header__notify-footer">
									<span class="header__notify-footer-btn">Chúc bạn mua sắm vui vẻ</span>
								</footer>
							</div>
						</li>
						<li class="header__navbar-item">
			...
			<div class="grid wide">
				<div class="row sm-gutter app__content">
						...
						<nav class="category">
							...
							<ul class="category-list">
								<li class="category-item">
									<a href="" id="0" class="category-item__link">Sản Phẩm</a>
								</li>
								<c:forEach items="${listCatalog}" var="catalog">
									<li class="category-item">
										<a href="" id="${catalog.id}" class="category-item__link">${catalog.name}</a>
									</li>
								</c:forEach>
							</ul>
						</nav>
					...
					<div class="col l-10 m-12 c-12">
						<div class="hone-filter hide-on-mobile-table">
							<span class="home-filter__label">Sắp xếp theo</span>
							<button class="home-filter-btn btn btn--primary sort_list" id="newSort">Mới Nhất</button>
							<button class="home-filter-btn btn sort_list" id="soldSort">Bán Chạy</button>
							<div class="select-input">
								<span class="select-input__label">Giá</span>
								<i class="select-input-icon fas fa-angle-down"></i>
								<ul class="select-input-list">
									<li class="select-input-item">
										<a class="select-input-link sort_list" href="" id="increated">Giá: &nbsp;Thấp đến Cao</a>
									</li>
									<li class="select-input-item">
										<a class="select-input-link sort_list" href="" id="descrease">Giá: &nbsp;Cao đến Thấp</a>
									</li>
								</ul>
							</div>
							<div class="home-filter__page">
								...
								<div class="home-filter__page-control">
									<a href="javascript:void(0)" class="home-filter__page-btn home-filter__page-btn--disable disabled">
										<i class="home-filter__page-icon fas fa-angle-left"></i>
									</a>
									<a href="javascript:void(0)" class="home-filter__page-btn disabled">
						...
						<nav class="mobile__category">
							<ul class="mobile__category-list">
								<li class="mobile__category-item">
									<a href="" class="mobile__category-link">
						...
						<ul class="pagination home__pagination">
							...
							<c:forEach items="${page}" var="p">
								<c:if test="${p==1}">
									<li class="pagination-item pagination-item-num pagination-item--active">
										<a class="pagination-item__link pagination-item__link-click">${p}</a>
									</li>
								</c:if>
								<c:if test="${p!=1}">
							...
							<li class="pagination-item">
								<a class="pagination-item__link next-page">
	...
	<script type="text/javascript">
	 Validator({
	      ...
	      onSubmit: function(data){
	    	var xhttp;
	    	console.log(data);
			var url = "register.htm?email="+data.email+"&password="+data.password+"&username="+data.username+"&address="+data.address;
	 ...
	 Validator({
	      ...
	      onSubmit: function(data){
	    	  var xhttp;
				var url = "login.htm?email="+data.email2+"&password="+data.password2;
				if (window.XMLHttpRequest) 
				{        
				    xhttp = new XMLHttpRequest(); 
				} 
				...
				xhttp.onreadystatechange= function() 
				{
					if (xhttp.readyState == 4)
					{
						...
						if(xhttp.status==403){
							...
							document.body.innerHTML=datars;
						}
					}
				}
				xhttp.open("POST",url,true);
